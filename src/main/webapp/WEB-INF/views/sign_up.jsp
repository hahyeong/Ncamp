        ...
        function chkExistId(){
            ...
            $.ajax({
                ...
                success:function(result){
                    if(result.trim()=='true'){
                        document.getElementById('modal-text').innerHTML="사용 가능한 ID입니다."
                        $('#existID').val('true')
                    }
                    else{
                        document.getElementById('modal-text').innerHTML="사용할 수 없는 ID입니다."
                        $('#existID').val('false')
                    }
                }
            })
...
<div id="container">
    ...
    <form:form action="${root}sign_up_proc" method="post" modelAttribute="signUpProcBean">
        <form:hidden path="existID"/>
        <div class="li">
            <label for="id">ID <span style="color: red">*</span></label>
            <form:input path="id" type="text" id="id" onkeypress="resetUser()"/>
            <button type="button" class="btn" onclick="chkExistId()"  data-bs-toggle="modal" data-bs-target="#exampleModal">중복 확인</button>
            <form:errors path="id" class="error_msg"/>
        </div>
        <div class="li">
        ...
        <div class="li">
            ...
            <form:errors path="name" class="error_msg"/>
        </div>
        <div class="li">
        ...
        <div class="li">
            ...
            <form:input type="text" path="birth_date" id="birth_date" placeholder="예) 19970817"/>
            <form:errors path="birth_date" class="error_msg"/>
        </div>
        <div class="li">
            <label for="email">E-mail <span style="color: red">*</span></label>
            <form:input path="email_name" type="text" id="email"/>
            <span>&nbsp;@&nbsp;</span>
            <form:input path="email_site" type="text" id="domain_text"/>&nbsp;
        ...
        <div class="li">
            ...
            <form:input type="text" path="zip_code" id="sample6_postcode" readonly="true"/>
            <input type="button" class="btn" onclick="sample6_execDaumPostcode()" value="우편번호 찾기">
        </div>
        <div class="li">
            <label for="sample6_address">주소 </label>
            <form:input type="text" path="address1" id="sample6_address"/>&nbsp;
            <form:input type="text" path="address2" id="sample6_detailAddress"/>
